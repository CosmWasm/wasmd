module github.com/CosmWasm/wasmd/tests/e2e
...
require (
	...
	github.com/CosmWasm/wasmd/demo v0.0.0-20231206122051-97a688a5d157
	github.com/CosmWasm/wasmd/x v0.0.0-00010101000000-000000000000
...
replace (
	...
	// local dirs
	github.com/CosmWasm/wasmd/demo => ../../demo
	github.com/CosmWasm/wasmd/x => ../../x
