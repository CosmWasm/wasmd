...
replace (
	// use a wasmvm compatible with comet
	// to fix, merge this: https://github.com/CosmWasm/wasmvm/pull/403
	github.com/CosmWasm/wasmvm => github.com/notional-labs/wasmvm v1.0.0-soon2.0.20230228141647-02cb0d87b5d5
