...
./integration/one_chain.sh wasmd $chainid0 ./data 26657 26656 6060 9090
./integration/one_chain.sh wasmd $chainid1 ./data 26557 26556 6061 9091
...
rly config init
rly config add-dir integration/configs/wasmd/
