...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `data_hash` | [bytes](#bytes) |  | The MD5 hash of the contract code |
| `creator` | [string](#string) |  | The creator address |
| `salt` | [bytes](#bytes) |  | The hex-encoded salt |
| `msg` | [bytes](#bytes) |  | JSON encoded init args |
...
| `BuildAddress` | [QueryBuildAddressRequest](#cosmwasm.wasm.v1.QueryBuildAddressRequest) | [QueryBuildAddressResponse](#cosmwasm.wasm.v1.QueryBuildAddressResponse) | ContractsByCreator gets the contracts by creator | |
