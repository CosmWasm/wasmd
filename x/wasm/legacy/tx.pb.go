...
type MsgStoreCode struct {
	...
	InstantiatePermission *wasmtypes.AccessConfig `protobuf:"bytes,5,opt,name=instantiate_permission,json=instantiatePermission,proto3" json:"instantiate_permission,omitempty"`
}
...
func (m *MsgStoreCode) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if m.InstantiatePermission == nil {
				m.InstantiatePermission = &wasmtypes.AccessConfig{}
			}
