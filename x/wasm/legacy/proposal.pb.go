...
type StoreCodeProposal struct {
	...
	InstantiatePermission *wasmtypes.AccessConfig `protobuf:"bytes,7,opt,name=instantiate_permission,json=instantiatePermission,proto3" json:"instantiate_permission,omitempty"`
}
