...
type InstantiateContractProposal struct {
	...
	Funds github_com_Finschia_finschia_sdk_types.Coins `protobuf:"bytes,8,rep,name=funds,proto3,castrepeated=github.com/Finschia/finschia-sdk/types.Coins" json:"funds"`
}
...
type ExecuteContractProposal struct {
	...
	// Funds coins that are transferred to the contract on instantiation
	Funds github_com_Finschia_finschia_sdk_types.Coins `protobuf:"bytes,6,rep,name=funds,proto3,castrepeated=github.com/Finschia/finschia-sdk/types.Coins" json:"funds"`
}
