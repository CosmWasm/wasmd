...
type MsgInstantiateContract struct {
	...
	// Types that are valid to be assigned to XLabel:
	//	*MsgInstantiateContract_Label
	XLabel isMsgInstantiateContract_XLabel `protobuf_oneof:"_label"`
...
type isMsgInstantiateContract_XLabel interface {
	isMsgInstantiateContract_XLabel()
	MarshalTo([]byte) (int, error)
	Size() int
}

type MsgInstantiateContract_Label struct {
	Label string `protobuf:"bytes,4,opt,name=label,proto3,oneof" json:"label,omitempty"`
}

func (*MsgInstantiateContract_Label) isMsgInstantiateContract_XLabel() {}

func (m *MsgInstantiateContract) GetXLabel() isMsgInstantiateContract_XLabel {
	if m != nil {
		return m.XLabel
	}
	return nil
...
func (m *MsgInstantiateContract) GetLabel() string {
	if x, ok := m.GetXLabel().(*MsgInstantiateContract_Label); ok {
		return x.Label
	}
	return ""
}
...
func (*MsgInstantiateContract) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*MsgInstantiateContract_Label)(nil),
	}
}
...
type MsgInstantiateContract2 struct {
	...
	CodeID uint64 `protobuf:"varint,3,opt,name=code_id,json=codeId,proto3" json:"code_id,omitempty"`
	// Types that are valid to be assigned to XLabel:
	//	*MsgInstantiateContract2_Label
	XLabel isMsgInstantiateContract2_XLabel `protobuf_oneof:"_label"`
	// Msg json encoded message to be passed to the contract on instantiation
	Msg RawContractMessage `protobuf:"bytes,5,opt,name=msg,proto3,casttype=RawContractMessage" json:"msg,omitempty"`
	// Funds coins that are transferred to the contract on instantiation
	Funds github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,6,rep,name=funds,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"funds"`
...
type isMsgInstantiateContract2_XLabel interface {
	isMsgInstantiateContract2_XLabel()
	MarshalTo([]byte) (int, error)
	Size() int
}

type MsgInstantiateContract2_Label struct {
	Label string `protobuf:"bytes,4,opt,name=label,proto3,oneof" json:"label,omitempty"`
}

func (*MsgInstantiateContract2_Label) isMsgInstantiateContract2_XLabel() {}

func (m *MsgInstantiateContract2) GetXLabel() isMsgInstantiateContract2_XLabel {
	if m != nil {
		return m.XLabel
	}
	return nil
...
func (m *MsgInstantiateContract2) GetLabel() string {
	if x, ok := m.GetXLabel().(*MsgInstantiateContract2_Label); ok {
		return x.Label
	}
	return ""
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*MsgInstantiateContract2) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*MsgInstantiateContract2_Label)(nil),
	}
}
...
var fileDescriptor_4f74d82755520264 = []byte{
	...
	,
}
	...
	if m.XLabel != nil {
		{
			size := m.XLabel.Size()
			i -= size
			if _, err := m.XLabel.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *MsgInstantiateContract_Label) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgInstantiateContract_Label) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.Label)
	copy(dAtA[i:], m.Label)
...
func (m *MsgInstantiateContract2_Label) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgInstantiateContract2_Label) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.Label)
	copy(dAtA[i:], m.Label)
	i = encodeVarintTx(dAtA, i, uint64(len(m.Label)))
...
func (m *MsgInstantiateContract_Label) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgInstantiateContract2_Label) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgInstantiateContract) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.XLabel = &MsgInstantiateContract_Label{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
...
func (m *MsgInstantiateContract2) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.XLabel = &MsgInstantiateContract2_Label{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Msg", wireType)
