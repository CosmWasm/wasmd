...
type MsgExecuteContract struct {
	...
	Funds github_com_Finschia_finschia_sdk_types.Coins `protobuf:"bytes,5,rep,name=funds,proto3,castrepeated=github.com/Finschia/finschia-sdk/types.Coins" json:"funds"`
}
