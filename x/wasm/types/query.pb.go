...
type QueryBuildAddressRequest struct {
	// The MD5 hash of the contract code
	DataHash github_com_cometbft_cometbft_libs_bytes.HexBytes `protobuf:"bytes,1,opt,name=data_hash,json=dataHash,proto3,casttype=github.com/cometbft/cometbft/libs/bytes.HexBytes" json:"data_hash,omitempty"`
	// The creator address
	Creator string `protobuf:"bytes,2,opt,name=creator,proto3" json:"creator,omitempty"`
	// The hex-encoded salt
	Salt RawContractMessage `protobuf:"bytes,3,opt,name=salt,proto3,casttype=RawContractMessage" json:"salt,omitempty"`
	// JSON encoded init args
...
var fileDescriptor_9677c207036b9f2b = []byte{
	...
	,
}
