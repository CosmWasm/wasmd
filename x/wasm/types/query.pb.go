...
type QueryBuildAddressRequest struct {
	...
	// Types that are valid to be assigned to XInitArgs:
	//	*QueryBuildAddressRequest_InitArgs
	XInitArgs isQueryBuildAddressRequest_XInitArgs `protobuf_oneof:"_init_args"`
}
...
type isQueryBuildAddressRequest_XInitArgs interface {
	isQueryBuildAddressRequest_XInitArgs()
	MarshalTo([]byte) (int, error)
	Size() int
}

type QueryBuildAddressRequest_InitArgs struct {
	InitArgs []byte `protobuf:"bytes,4,opt,name=init_args,json=initArgs,proto3,oneof" json:"init_args,omitempty"`
}

func (*QueryBuildAddressRequest_InitArgs) isQueryBuildAddressRequest_XInitArgs() {}

func (m *QueryBuildAddressRequest) GetXInitArgs() isQueryBuildAddressRequest_XInitArgs {
	if m != nil {
		return m.XInitArgs
	}
	return nil
...
func (m *QueryBuildAddressRequest) GetInitArgs() []byte {
	if x, ok := m.GetXInitArgs().(*QueryBuildAddressRequest_InitArgs); ok {
		return x.InitArgs
	}
	return nil
}
...
func (*QueryBuildAddressRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*QueryBuildAddressRequest_InitArgs)(nil),
	}
}
...
var fileDescriptor_9677c207036b9f2b = []byte{
	...
	,
}
...
func (m *QueryBuildAddressRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.XInitArgs != nil {
		{
			size := m.XInitArgs.Size()
			i -= size
			if _, err := m.XInitArgs.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *QueryBuildAddressRequest_InitArgs) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryBuildAddressRequest_InitArgs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.InitArgs != nil {
		i -= len(m.InitArgs)
...
func (m *QueryBuildAddressRequest_InitArgs) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryBuildAddressRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.XInitArgs = &QueryBuildAddressRequest_InitArgs{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
