...
import (
	...
	"github.com/codchen/wasmd/x/wasm/ibctesting"
	wasmkeeper "github.com/codchen/wasmd/x/wasm/keeper"
...
func TestIBCReflectContract(t *testing.T) {
	...
	// eg. ibctransfer doesn't store the packet either: https://github.com/cosmos/cosmos-sdk/blob/master/x/ibc/apps/transfer/keeper/relay.go#L145-L162
