...
type MockChannelKeeper struct {
	...
	ChanCloseInitFn                func(ctx context.Context, portID, channelID string) error
...
func (m *MockICS4Wrapper) SendPacket(ctx context.Context, sourcePort, sourceChannel string, timeoutHeight clienttypes.Height, timeoutTimestamp uint64, data []byte) (uint64, error) {
