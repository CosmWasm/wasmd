...
import (
	...
	"github.com/golang/protobuf/proto" //nolint:staticcheck // SA1019: proto is deprecated: Use the "google.golang.org/protobuf/proto" package instead. (staticcheck)
...
func toReflectRawMsg(cdc codec.Codec, msg sdk.Msg) (wasmvmtypes.CosmosMsg, error) {
	...
	customMsg, err := json.Marshal(reflectCustomMsg{ //nolint:errcheck,staticcheck
		Raw: rawBz,
	})
