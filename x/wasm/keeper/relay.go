...
func (k Keeper) OnOpenChannel(
	...
	if err != nil {
		...
		return "", sdkerrors.Wrap(types.ErrInvalidMsg, err.Error())
	}
	setupCost := k.gasRegister.InstantiateContractCosts(k.IsPinnedCode(ctx, contractInfo.CodeID), len(msgBz))
	ctx.GasMeter().ConsumeGas(setupCost, "Loading CosmWasm module: ibc-open-channel")
...
func (k Keeper) OnConnectChannel(
	...
	setupCost := k.gasRegister.InstantiateContractCosts(k.IsPinnedCode(ctx, contractInfo.CodeID), len(msgBz))
	ctx.GasMeter().ConsumeGas(setupCost, "Loading CosmWasm module: ibc-connect-channel")
...
func (k Keeper) OnCloseChannel(
	...
	setupCost := k.gasRegister.InstantiateContractCosts(k.IsPinnedCode(ctx, contractInfo.CodeID), len(msgBz))
	ctx.GasMeter().ConsumeGas(setupCost, "Loading CosmWasm module: ibc-close-channel")
...
func (k Keeper) OnRecvPacket(
	...
	setupCost := k.gasRegister.InstantiateContractCosts(k.IsPinnedCode(ctx, contractInfo.CodeID), len(msgBz))
	ctx.GasMeter().ConsumeGas(setupCost, "Loading CosmWasm module: ibc-recv-packet")
...
func (k Keeper) OnAckPacket(
	...
	setupCost := k.gasRegister.InstantiateContractCosts(k.IsPinnedCode(ctx, contractInfo.CodeID), len(msgBz))
	ctx.GasMeter().ConsumeGas(setupCost, "Loading CosmWasm module: ibc-ack-packet")
...
func (k Keeper) OnTimeoutPacket(
	...
	setupCost := k.gasRegister.InstantiateContractCosts(k.IsPinnedCode(ctx, contractInfo.CodeID), len(msgBz))
	ctx.GasMeter().ConsumeGas(setupCost, "Loading CosmWasm module: ibc-timeout-packet")
