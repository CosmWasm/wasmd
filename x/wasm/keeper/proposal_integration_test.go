...
func TestStoreCodeProposal(t *testing.T) {
	...
	// when stored
	storedProposal, err := govKeeper.SubmitProposal(ctx, src, true)
	require.NoError(t, err)
...
func TestInstantiateProposal_NoAdmin(t *testing.T) {
	...
	_, err = govKeeper.SubmitProposal(ctx, src, true)
	require.Error(t, err)
...
func TestExecuteProposal(t *testing.T) {
	...
	storedProposal, err := govKeeper.SubmitProposal(ctx, &badSrc, true)
	require.Error(t, err)
...
func TestAdminProposals(t *testing.T) {
	...
	for msg, spec := range specs {
		t.Run(msg, func(t *testing.T) {
			...
			// when stored
			storedProposal, err := govKeeper.SubmitProposal(ctx, spec.srcProposal, true)
			require.NoError(t, err)
...
func TestUpdateParamsProposal(t *testing.T) {
	...
	for msg, spec := range specs {
		t.Run(msg, func(t *testing.T) {
			...
			// when stored
			storedProposal, err := govKeeper.SubmitProposal(ctx, &proposal, true)
			require.NoError(t, err)
...
func TestPinCodesProposal(t *testing.T) {
	...
	for msg, spec := range specs {
		t.Run(msg, func(t *testing.T) {
			...
			// when stored
			storedProposal, gotErr := govKeeper.SubmitProposal(ctx, &proposal, true)
			if spec.expErr {
