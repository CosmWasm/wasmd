...
func TestInstantiateProposal(t *testing.T) {
	...
	var (
		oneAddress   sdk.AccAddress = bytes.Repeat([]byte{0x1}, 32)
		otherAddress sdk.AccAddress = bytes.Repeat([]byte{0x2}, 32)
	)
...
func TestMigrateProposal(t *testing.T) {
	...
	var (
		anyAddress   sdk.AccAddress = bytes.Repeat([]byte{0x1}, 32)
		otherAddress sdk.AccAddress = bytes.Repeat([]byte{0x2}, 32)
...
func TestUpdateParamsProposal(t *testing.T) {
	...
	var (
		...
		myAddress              sdk.AccAddress = make([]byte, 32)
